...
/********************************************************/
/*se podría hacer una función que pasándole un id de curso,
 que devuelva el nombre del curso,
 así se podría pasar a un solo for de alumnos para mostrar el alumno con el nombre del curso*/
